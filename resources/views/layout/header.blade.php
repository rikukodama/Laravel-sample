<div id="header" class="clearfix">
    <h1>
        <a href="{{ url('/') }}">
            <img src="{{ asset('img/logo.png') }}" height="40" alt="抹茶請求書">
        </a>
    </h1>
    <div id="logout">
        <a href="{{ route('logout') }}"><img src="{{ asset('img/bt_logout.jpg') }}" alt="ログアウト" class="imgover"></a>
    </div>
    <br class="clear" />
    @php
        ...
        <ul id="menu" class="menu">
            ...
            <li>
                ...
                <ul class="dmenu">
                    ...
                    <li><span><a href="{{ route('quotes.add') }}">見積書を作成する</a></span></li>
                    <li class="line">"><img src="{{ asset('/img/i_line_dmenu.gif') }}"></li>
