...
class Quote extends Model
{
  ...
  'TEN_RATE_TOTAL',
    ...
    {
        $form = new Form();
        return $form->getHonor($company_id);
    }
    ...
    {
        $form = new Form();
        return $form->getPayment($company_id);
    }
    ...
    {
        $form = new Form();
        return $form->getCompanyPayment($company_id);
    }
    ...
    {
        $form = new Form();
        return $form->getSerial($company_id);
    }
    ...
    public function setData($param, $state = null, $error)
    {
        ...
        $form = new Form();
        return $form->setReplicationData($param, 'Quote', $state, $error);
    }
